...
enum class FlipperAction : uint16_t {
    ...
    GpioRead = 50,
    PropertyGet = 60,
    // High-risk capabilities are intentionally reference/profile based. No raw RF bytes,
    // secret extraction, target discovery, password enumeration, or free-form commands.
